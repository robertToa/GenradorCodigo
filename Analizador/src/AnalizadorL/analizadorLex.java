...
public class analizadorLex{	
	...
	private void lecturaArchivo(){
		try{
			FileReader fileName=new FileReader(BuscarArchivo.fileName);
	...
	private void CrearArchivoSalida(){
		try{
			System.out.println(BuscarArchivo.fileNameSalida);
			FileWriter fileNa=new FileWriter(BuscarArchivo.fileNameSalida+".csv");
