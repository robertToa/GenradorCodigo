...
public class OperacionCom extends JFrame implements ActionListener{
	...
	public void construirVentana(){
		jfrVentana= new JFrame("OPERADORES COMPUESTOS EN EL TEXTO");
	...
	private void ImpresionPalabras(){
		...
		for(int i=0;i<analizadorLex.cadena.size();i++){
			String[] cadena=(analizadorLex.cadena.get(i)).split(";");
				if(cadena[0].equals("Operador Compuesto")){
					datoFin[0]=cadena[1];
							datoFin[1]=cadena[2];
	...
	public static void main (String [] args ){
		OperacionCom main=new OperacionCom();
