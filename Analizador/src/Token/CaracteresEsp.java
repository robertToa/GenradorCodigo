...
public class CaracteresEsp extends JFrame implements ActionListener{
	...
	private void ImpresionPalabras(){
		...
		for(int i=0;i<analizadorLex.cadena.size();i++){
			String[] cadena=(analizadorLex.cadena.get(i)).split(";");
				if(cadena[0].equals("Caracter Especial")){
					datoFin[0]=cadena[1];
							datoFin[1]=cadena[2];
	...
	public static void main (String [] args ){
		CaracteresEsp main=new CaracteresEsp();
